...
print(quota.catch(-1, 1000, rfib, 100))
--> =false

-- Recursion blows cpu budget
print(quota.catch(10000, -1, rfib, 100))
--> =false
...
print(quota.catch(-1, 1000, ifib, 100))
--> =true	3736710778780434371

-- cpu usage doesn't explode
print(quota.catch(10000, -1, ifib, 100))
--> =true	3736710778780434371

-- we can run out of cpu eventually!
print(quota.catch(1000, -1, ifib, 1000))
--> =false
...
ok, bigs = quota.catch(1000, -1, strexp, "hi", 16)
print(ok, #bigs)
--> =true	65536

--> but it consumes memory!
print(quota.catch(-1, 50000, strexp, "hi", 16))
--> =false
